...
<template>
    <div :class="[scrolltop ? 'h-[60px]' : 'h-[60px] lg:h-[80px]']"
        ...
        <div class="items-center space-x-4 lg:space-x-10 hidden md:flex">
            <NuxtLink to="/" class="p-2 text-white no-underline hover:text-black hover:bg-white rounded-md">首頁</NuxtLink>
            <div @mouseover="gamesDrop = true" @mouseleave="gamesDrop = false" class="relative flex justify-center items-start group cursor-pointer">
            ...
            <div @mouseover="newsDrop = true" @mouseleave="newsDrop = false" class="relative flex justify-center items-start group cursor-pointer">
    ...
    <transition name="nav" mode="out-in">
        <div v-if="nav" class="fixed top-[60px] z-50 w-screen max-h-[400px] bg-white shadow-xl flex flex-col items-start justify-start px-3 py-2 overflow-y-scroll">
            ...
            <div @click="navbtnDrop('games')" :class="[gamesbtn ? 'text-main' : '']" class="w-full text-center p-3 border-b border-gray-400 cursor-pointer relative">電子遊戲
                <svg class="fill-main absolute right-7 top-[17px]" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><path d="M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z"/></svg>
            </div>
