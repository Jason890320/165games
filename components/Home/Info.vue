...
<template>
    <div v-if="!loading" @click="clickclose" class="fixed top-0 left-0 w-full h-full z-[60] bg-[#c4c4c4cc] flex justify-center items-center px-4 py-8">   
        <div id="temp" class="bg-main py-8 px-4 md:px-8 w-[850px] max-h-[900px] rounded-xl flex flex-col items-center shadow-xl relative overflow-y-scroll noscrollbar">
